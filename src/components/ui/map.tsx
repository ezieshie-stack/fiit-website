...
// Patched for CSS-Modules project (no Tailwind): inline styles instead of utility classes.
const _loaderBox: React.CSSProperties = {
  position: "absolute",
  inset: 0,
  display: "flex",
  alignItems: "center",
...
const _loaderDot: React.CSSProperties = {
  width: 6,
  height: 6,
  borderRadius: 9999,
  background: "rgba(255,255,255,0.6)",
  animation: "fiitMapPulse 1.2s ease-in-out infinite",
};
const DefaultLoader = () => (
  <div style={_loaderBox}>
    <div style={{ display: "flex", gap: 4 }}>
      <span style={_loaderDot} />
      <span style={{ ..._loaderDot, animationDelay: "150ms" }} />
      <span style={{ ..._loaderDot, animationDelay: "300ms" }} />
    </div>
  </div>
);
